...
SETTINGS="validation/iti_general_min_norm_q_cap_heldout_settings.json"
REFERENCE="artifacts/iti_attention_head/heldout_general_min_norm_ridge_confirm_k48"
OUT="artifacts/iti_attention_head/heldout_general_min_norm_q_cap_r0p1_k48"
LOGS="artifacts/iti_attention_head/logs"
BASELINE="aggregate_com_k48_a20_q0p75_r0p1_c3"
CANDIDATES=(
  aggregate_com_k48_a20_q0p7_r0p1_c3
  aggregate_com_k48_a20_q0p7_r0p1_c2p5
)
...
run_fold() {
  ...
  env CUDA_VISIBLE_DEVICES="$GPU" \
    ...
    "$PYTHON_BIN" validation/validate_causal_head_perturbation.py \
      ...
      >"$LOGS/general_min_norm_q_cap_heldout_fold${fold}.log" 2>&1
}
...
"$PYTHON_BIN" validation/summarize_causal_head_results.py \
  ...
  >"$LOGS/general_min_norm_q_cap_heldout_summary.log" 2>&1
...
for candidate in "${CANDIDATES[@]}"; do
  "$PYTHON_BIN" validation/compare_paired_mc.py \
    ...
    >"$LOGS/general_min_norm_q_cap_${candidate}_paired.log" 2>&1
done
