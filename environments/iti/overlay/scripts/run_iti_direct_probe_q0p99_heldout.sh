...
SETTINGS="validation/iti_direct_probe_q0p99_heldout_settings.json"
OUTPUT="artifacts/iti_attention_head/heldout_direct_probe_q0p99_k48"
FIXED_REFERENCE="artifacts/iti_attention_head/heldout_k48"
LOGS="artifacts/iti_attention_head/logs"
CANDIDATE="targeted_probe_iti_k48_a1_q0p99_r0"
...
run_fold() {
  ...
  env CUDA_VISIBLE_DEVICES="$gpu" \
    ...
    "$PYTHON_BIN" validation/validate_causal_head_perturbation.py \
      ...
      >"$LOGS/direct_probe_q0p99_heldout_fold${fold}.log" 2>&1
}
...
"$PYTHON_BIN" validation/summarize_causal_head_results.py \
  ...
  >"$LOGS/direct_probe_q0p99_heldout_summary.log" 2>&1
...
"$PYTHON_BIN" validation/compare_paired_mc.py \
  ...
  >"$LOGS/direct_probe_q0p99_paired_vs_baseline.log" 2>&1
...
"$PYTHON_BIN" validation/compare_paired_mc.py \
  ...
  >"$LOGS/direct_probe_q0p99_paired_vs_fixed_a15.log" 2>&1
